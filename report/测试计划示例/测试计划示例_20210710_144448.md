...
|------|-------|-------|------|-----------|---------|-----------|-----|---------|------|--------|
| 1 | 打开 |  | http://baidu.com |<div title="#tab=百度">#tab=百度</div>                     | <div title=""></div> | <div title=""></div>                     | 10.9 | <font color=#00BB00>通过</font> |  |  |
...
| 步骤  | 操作  | app  | 元素  | 测试数据  | 预期结果 | 输出数据  | 耗时 | 测试结果 | 备注 | 截图   |
|------|-------|-------|------|-----------|---------|-----------|-----|---------|------|--------|
| 1 | 打开 |  | http://baidu.com |<div title="#tab=百度">#tab=百度</div>                     | <div title=""></div> | <div title=""></div>                     | 1.1 | <font color=#00BB00>通过</font> |  |  |
| 2 | 检查 |  | title |<div title="百度一下，你就知道">百度一下，你就知道</div>                     | <div title=""></div> | <div title=""></div>                     | 0.2 | <font color=#00BB00>通过</font> |  |  |
