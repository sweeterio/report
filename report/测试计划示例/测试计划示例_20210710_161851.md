# 「测试计划示例」自动化测试执行报告 <font color=#FF0000>失败</font> #
...
|------|-------|-------|------|-----------|---------|-----------|-----|---------|------|--------|
| 1 | 打开 |  | http://baidu.com |<div title="#tab=百度">#tab=百度</div>                     | <div title=""></div> | <div title=""></div>                     | 8.7 | <font color=#00BB00>通过</font> |  |  |
| 2 | 检查 |  | title |<div title="百度一下，你就知道">百度一下，你就知道</div>                     | <div title=""></div> | <div title=""></div>                     | 0.3 | <font color=#FF0000>失败</font> |  |  |
...
| 步骤  | 操作  | app  | 元素  | 测试数据  | 预期结果 | 输出数据  | 耗时 | 测试结果 | 备注 | 截图   |
|------|-------|-------|------|-----------|---------|-----------|-----|---------|------|--------|
| 1 | 打开 |  | http://baidu.com |<div title="#tab=百度">#tab=百度</div>                     | <div title=""></div> | <div title=""></div>                     | 1.0 | <font color=#00BB00>通过</font> |  |  |
| 2 | 检查 |  | title |<div title="百度一下，你就知道">百度一下，你就知道</div>                     | <div title=""></div> | <div title=""></div>                     | - | <font color=#FF0000>失败</font> |  |  |
...
| 步骤  | 操作  | app  | 元素  | 测试数据  | 预期结果 | 输出数据  | 耗时 | 测试结果 | 备注 | 截图   |
|------|-------|-------|------|-----------|---------|-----------|-----|---------|------|--------|
| 1 | 打开 |  | http://baidu.com |<div title="#tab=百度">#tab=百度</div>                     | <div title=""></div> | <div title=""></div>                     | 5.0 | <font color=#00BB00>通过</font> |  |  |
...
- ##### <font color=#cf9e9e>测试用例</font> <font color=#858585>douban#001*3</font> <font color=#cf9e9e> | </font> <span title="搜索：<kw>"><font color=#858585>搜索：北京</font></span> <span id="douban0013"></span>
...
| 步骤  | 操作  | app  | 元素  | 测试数据  | 预期结果 | 输出数据  | 耗时 | 测试结果 | 备注 | 截图   |
|------|-------|-------|------|-----------|---------|-----------|-----|---------|------|--------|
| 1 | 打开 |  | http://baidu.com |<div title="#tab=百度">#tab=百度</div>                     | <div title=""></div> | <div title=""></div>                     | 1.6 | <font color=#00BB00>通过</font> |  |  |
| 2 | 检查 |  | title |<div title="百度一下，你就知道">百度一下，你就知道</div>                     | <div title=""></div> | <div title=""></div>                     | 0.2 | <font color=#00BB00>通过</font> |  |  |
